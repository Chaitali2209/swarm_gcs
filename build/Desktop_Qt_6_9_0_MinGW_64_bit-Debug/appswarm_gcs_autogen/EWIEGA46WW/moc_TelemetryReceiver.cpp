/****************************************************************************
** Meta object code from reading C++ file 'TelemetryReceiver.h'
**
...
#error "The header file 'TelemetryReceiver.h' doesn't include <QObject>."
...
void TelemetryReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->telemetryReceived((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1]))); break;
        case 1: _t->readPendingDatagrams(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TelemetryReceiver::*)(QJsonObject )>(_a, &TelemetryReceiver::telemetryReceived, 0))
            return;
    }
}
...
// SIGNAL 0
void TelemetryReceiver::telemetryReceived(QJsonObject _t1)
{
